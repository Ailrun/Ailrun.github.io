...
명제의 정의는 무엇인가? 명제는 논리학의 긴 역사만큼 다양한 정의를 가지고 있기 때문에 한마디로 답하기 쉽지 않은 질문이다. 이 장에서는 명제의 정의를 오래된 것부터 차례대로 살펴보고 어떤 정의를 기준으로 논의를 이어나갈지 이야기해보도록 할 것이다.
...
### 명제가 이렇게 복잡한데... 그걸 증명한다고?: 논증

다행인지 불행인지 명제의 복잡함에 비하면 논증은 비교적 간단하다. 
