...
(function($PS) {
  ...
  var render = function (v) {
      var bannerPositionClassName = function (n) {
          ...
          throw new Error("Failed pattern match at Component.MainPage (line 69, column 5 - line 71, column 39): " + [ n.constructor.name ]);
      };
...
(function($PS) {
  ...
  var blogPageToPath = function (v) {
      ...
      throw new Error("Failed pattern match at Data.BlogPage (line 16, column 1 - line 16, column 37): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var render = function (v) {
      var blogPageToText = function (v1) {
          ...
          throw new Error("Failed pattern match at Component.NavigationBar (line 68, column 5 - line 68, column 39): " + [ v1.constructor.name ]);
      };
...
(function($PS) {
  ...
  var projectSections = [ {
      ...
      projects: [ {
          ...
          images: [ "https://img.shields.io/badge/Version-0.01.01-lightgrey.svg?style=flat", "https://img.shields.io/badge/Status-Alpha-yellow.svg?style=flat" ]
      }, {
          title: "coq-commenter",
  ...
  var render = function (v) {
      ...
      var renderProject = function (p) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.article_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("-") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(p.link) ])([ Halogen_HTML_Core.text(p.title) ]) ]), Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)((function () {
              ...
              return function ($3) {
                  return Halogen_HTML_Elements.img($2(Halogen_HTML_Properties.src($3)));
              };
          })())(p.images)) ]) ]);
      };
      ...
      var renderCurrentPage = (function () {
          if (state.currentPage instanceof Data_BlogPage.AboutPage) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "aboutPage";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Component_AboutPage.component)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentPage instanceof Data_BlogPage.MainPage) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "mainPage";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Component_MainPage.component)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentPage instanceof Data_BlogPage.ProjectsPage) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "projectsPage";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Component_ProjectsPage.component)(Data_Unit.unit)(Data_Void.absurd);
          };
          throw new Error("Failed pattern match at Component.App (line 59, column 25 - line 62, column 84): " + [ state.currentPage.constructor.name ]);
      })();
      return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "navigationBar";
      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Component_NavigationBar.component)(state.currentPage)(function ($10) {
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var v1 = (function () {
          ...
          if (v instanceof Data_Maybe.Nothing) {
              Routing_Hash.setHash(Data_BlogPage.blogPageToPath(Data_BlogPage.MainPage.value))();
              return Data_BlogPage.MainPage.value;
          };
          throw new Error("Failed pattern match at Main (line 20, column 11 - line 25, column 23): " + [ v.constructor.name ]);
      })();
