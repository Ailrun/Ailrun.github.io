...
(function($PS) {
  ...
  var render = function (v) {
      var renderTop = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.pageTitleClassName) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("img/about.png") ]), Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("About") ]) ]) ]);
...
(function($PS) {
  ...
  var render = function (v) {
      var bannerPositionClassName = function (n) {
          ...
          throw new Error("Failed pattern match at Component.MainPage (line 70, column 5 - line 72, column 39): " + [ n.constructor.name ]);
      };
...
(function($PS) {
  ...
  var render = function (v) {
      var renderTop = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.pageTitleClassName) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("img/project.png") ]), Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Projects") ]) ]) ]);
...
(function($PS) {
  ...
  var render = function (state) {
      ...
      }))(Data_Ord.ordUnit)(_navigationBar)(Data_Unit.unit)(Component_NavigationBar.component)(state.currentPage)(function ($11) {
          return Data_Maybe.Just.create(MoveToPage.create($11));
...
(function($PS) {
  ...
  var main = function __do() {
      var v = Data_Functor.map(Effect.functorEffect)(Data_BlogPage.pathToBlogPage)(Routing_Hash.getHash)();
      var v1 = (function () {
          if (v instanceof Data_Maybe.Just) {
              return v.value0;
          };
          ...
          throw new Error("Failed pattern match at Main (line 20, column 11 - line 25, column 15): " + [ v.constructor.name ]);
      })();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v2) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Maybe.fromMaybe(v2))(Halogen_Aff_Util.selectElement("head")))(function (v3) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Style.component)(Data_Unit.unit)(v3))(function (v4) {
                  return Halogen_VDom_Driver.runUI(Component_App.component)(v1)(v2);
              });
          });
      }))();
  };
