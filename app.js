...
(function($PS) {
  ...
  var valListStyleType = new CSS_Property.Val(function (v) {
      ...
      throw new Error("Failed pattern match at CSS.ListStyle.Type (line 37, column 1 - line 50, column 43): " + [ v.constructor.name ]);
  });                       
  ...
  exports["noneListTypeType"] = noneListTypeType;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  ...
  exports["whitespacePreWrap"] = whitespacePreWrap;
...
(function($PS) {
  ...
  var imageRoot = "https://raw.githubusercontent.com/Ailrun/media/master/blog-img/";
...
(function($PS) {
  ...
  var DefaultRecord = function (defRecord) {
      this.defRecord = defRecord;
  };
  var Default = function (def) {
      this.def = def;
  };
  var unitDefault = new Default(Data_Monoid.mempty(Data_Monoid.monoidUnit));
  var stringDefault = new Default(Data_Monoid.mempty(Data_Monoid.monoidString));
  var sproxyDefault = new Default(Data_Symbol.SProxy.value);
  var rlproxyDefault = new Default(Type_Data_RowList.RLProxy.value);
  var nilDefaultRecord = new DefaultRecord(function (v) {
      return {};
  });                             
  var defRecord = function (dict) {
      return dict.defRecord;
  };
  var def = function (dict) {
      return dict.def;
  };
  var recordDefault = function (dictRowToList) {
      return function (dictDefaultRecord) {
          return new Default(defRecord(dictDefaultRecord)(def(rlproxyDefault)));
      };
  };
  var consDefaultRecord = function (dictIsSymbol) {
      return function (dictDefault) {
          return function (dictCons) {
              return function (dictDefaultRecord) {
                  return new DefaultRecord(function (v) {
                      var tail = defRecord(dictDefaultRecord)(def(rlproxyDefault));
                      var key = Data_Symbol.reflectSymbol(dictIsSymbol)(def(sproxyDefault));
                      return Record_Unsafe.unsafeSet(key)(def(dictDefault))(tail);
                  });
              };
          };
      };
  };
  var arrayDefault = new Default(Data_Monoid.mempty(Data_Monoid.monoidArray));
  exports["Default"] = Default;
  exports["def"] = def;
  exports["stringDefault"] = stringDefault;
  exports["arrayDefault"] = arrayDefault;
  exports["unitDefault"] = unitDefault;
  exports["sproxyDefault"] = sproxyDefault;
  exports["recordDefault"] = recordDefault;
  exports["nilDefaultRecord"] = nilDefaultRecord;
  exports["consDefaultRecord"] = consDefaultRecord;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Style.Class"] = $PS["Style.Class"] || {};
  var exports = $PS["Style.Class"];
  var CSS_Selector = $PS["CSS.Selector"];                
  var classPrefix = "ailrun-blog-";
  var mainPageClassName = classPrefix + "main-page";
  var mainPageSelector = new CSS_Selector.Selector([ new CSS_Selector.Class(mainPageClassName) ], CSS_Selector.Star.value);
  var navigationBarClassName = classPrefix + "navigation-bar";
  var navigationBarSelector = new CSS_Selector.Selector([ new CSS_Selector.Class(navigationBarClassName) ], CSS_Selector.Star.value);
  var pageMainClassName = classPrefix + "page-main";
  var pageMainSelector = new CSS_Selector.Selector([ new CSS_Selector.Class(pageMainClassName) ], CSS_Selector.Star.value);
  var pageTitleClassName = classPrefix + "page-title";
  var pageTitleSelector = new CSS_Selector.Selector([ new CSS_Selector.Class(pageTitleClassName) ], CSS_Selector.Star.value);
  var projectsPageClassName = classPrefix + "projects-page";
  var projectsPageSelector = new CSS_Selector.Selector([ new CSS_Selector.Class(projectsPageClassName) ], CSS_Selector.Star.value);
  var alignRightClassName = classPrefix + "align-right";
  var alignRightSelector = new CSS_Selector.Selector([ new CSS_Selector.Class(alignRightClassName) ], CSS_Selector.Star.value);
  var alignLeftClassName = classPrefix + "align-left";
  var alignLeftSelector = new CSS_Selector.Selector([ new CSS_Selector.Class(alignLeftClassName) ], CSS_Selector.Star.value);
  var aboutPageClassName = classPrefix + "about-page";
  var aboutPageSelector = new CSS_Selector.Selector([ new CSS_Selector.Class(aboutPageClassName) ], CSS_Selector.Star.value);
  exports["aboutPageClassName"] = aboutPageClassName;
  exports["aboutPageSelector"] = aboutPageSelector;
  exports["alignLeftClassName"] = alignLeftClassName;
  exports["alignLeftSelector"] = alignLeftSelector;
  exports["alignRightClassName"] = alignRightClassName;
  exports["alignRightSelector"] = alignRightSelector;
  exports["mainPageClassName"] = mainPageClassName;
  exports["mainPageSelector"] = mainPageSelector;
  exports["navigationBarClassName"] = navigationBarClassName;
  exports["navigationBarSelector"] = navigationBarSelector;
  exports["pageMainClassName"] = pageMainClassName;
  exports["pageMainSelector"] = pageMainSelector;
  exports["pageTitleClassName"] = pageTitleClassName;
  exports["pageTitleSelector"] = pageTitleSelector;
  exports["projectsPageClassName"] = projectsPageClassName;
  exports["projectsPageSelector"] = projectsPageSelector;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Component.AboutPage"] = $PS["Component.AboutPage"] || {};
  var exports = $PS["Component.AboutPage"];
  ...
  var Style_Class = $PS["Style.Class"];                
  var subjects = [ {
      title: "Hobby",
      entries: [ "Enjoy life with beers", "Fall in love with foods", "Writing poems" ]
  }, {
      title: "Contact",
      entries: [ "Github/Ailrun" ]
  }, {
      title: "Education",
      entries: [ "Seoul Nat'l Univ, Bachelor's degree of Chemistry", "Seoul Nat'l Univ, Bachelor's degree of Philosophy", "Seoul Nat'l Univ, Bachelor's degree of Computer Science and Engineering" ]
  } ];
  var render = function (v) {
      var renderTop = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.pageTitleClassName) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(Constants.imageRoot + "about.png") ]), Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("About") ]) ]) ]);
      var renderEntry = function (e) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("- " + e) ]);
      };
      var renderSubject = function (s) {
          return Halogen_HTML_Elements.article_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text(s.title) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderEntry)(s.entries)) ]) ]);
      };
      var renderBottom = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.pageMainClassName) ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Junyoung Clare Jang") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Style_Class.alignLeftClassName) ])(Data_Functor.map(Data_Functor.functorArray)(renderSubject)(subjects)), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Style_Class.alignRightClassName) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(Constants.imageRoot + "about-profile.png") ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Clare with cups of beer") ]) ]) ]);
      return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.aboutPageClassName) ])([ renderTop, renderBottom ]);
  };
  var initialState = function (v) {
      return Data_Default.def(Data_Default.unitDefault);
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Component.MainPage"] = $PS["Component.MainPage"] || {};
  var exports = $PS["Component.MainPage"];
  var Constants = $PS["Constants"];
  var Data_Array = $PS["Data.Array"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Default = $PS["Data.Default"];
  ...
  var banners = [ {
      title: "Haskell",
      description: "Modern, Pure, Beautiful\x0aFunctional Language",
      linkTitle: "Haskell Projects",
      background: Constants.imageRoot + "haskell.png"
  }, {
      title: "Beer",
      description: "The World's Greatest Drink",
      linkTitle: "Beer Lists",
      background: Constants.imageRoot + "beer.png"
  }, {
      title: "Elm",
      description: "Functional Web Language\x0awith MVC",
      linkTitle: "Elm Projects",
      background: Constants.imageRoot + "elm.png"
  }, {
      title: "Purescript",
      description: "Functional Web Language\x0a that is done right",
      linkTitle: "Purescript Projects",
      background: Constants.imageRoot + "purescript.png"
  } ];
  var render = function (v) {
      var bannerPositionClassName = function (n) {
          if (Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(n)(2) === 0) {
              return Style_Class.alignRightClassName;
          };
          if (Data_Boolean.otherwise) {
              return Style_Class.alignLeftClassName;
          };
          throw new Error("Failed pattern match at Component.MainPage (line 71, column 5 - line 73, column 39): " + [ n.constructor.name ]);
      };
      var renderBanner = function (n) {
          return function (b) {
              return Halogen_HTML_Elements.article([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName(bannerPositionClassName(n))) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(b.background) ]), Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text(b.title) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(b.description) ]) ]) ]), Halogen_HTML_Elements.a_([ Halogen_HTML_Core.text(b.linkTitle + " >") ]) ]);
          };
      };
      var renderBanners = Data_Array.mapWithIndex(renderBanner)(banners);
      return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.mainPageClassName) ])(renderBanners);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Data.BlogPage"] = $PS["Data.BlogPage"] || {};
  var exports = $PS["Data.BlogPage"];
  var Data_Default = $PS["Data.Default"];
  var Data_Maybe = $PS["Data.Maybe"];                
  ...
  var ProjectsPage = (function () {
      ...
      ProjectsPage.value = new ProjectsPage();
      return ProjectsPage;
  })();
  var pathToHash = function (p) {
      return "#" + p;
  };
  var pathToBlogPage = function (v) {
      if (v === "about") {
          return new Data_Maybe.Just(AboutPage.value);
      };
      if (v === "") {
          return new Data_Maybe.Just(MainPage.value);
      };
      if (v === "projects") {
          return new Data_Maybe.Just(ProjectsPage.value);
      };
      return Data_Maybe.Nothing.value;
  };
  var blogPageToPath = function (v) {
      if (v instanceof AboutPage) {
          return "about";
      };
      if (v instanceof MainPage) {
          return "";
      };
      if (v instanceof ProjectsPage) {
          return "projects";
      };
      throw new Error("Failed pattern match at Data.BlogPage (line 20, column 1 - line 20, column 37): " + [ v.constructor.name ]);
  };
  var blogPageDefault = new Data_Default.Default(MainPage.value);
  exports["AboutPage"] = AboutPage;
  exports["MainPage"] = MainPage;
  exports["ProjectsPage"] = ProjectsPage;
  exports["blogPageToPath"] = blogPageToPath;
  exports["pathToBlogPage"] = pathToBlogPage;
  exports["pathToHash"] = pathToHash;
  exports["blogPageDefault"] = blogPageDefault;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Component.NavigationBar"] = $PS["Component.NavigationBar"] || {};
  var exports = $PS["Component.NavigationBar"];
  var Data_BlogPage = $PS["Data.BlogPage"];
  var Data_Default = $PS["Data.Default"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_Component = $PS["Halogen.Component"];
  ...
  var Style_Class = $PS["Style.Class"];                
  var render = function (v) {
      var blogPageToText = function (v1) {
          if (v1 instanceof Data_BlogPage.AboutPage) {
              return "About";
          };
          if (v1 instanceof Data_BlogPage.MainPage) {
              return "Main";
          };
          if (v1 instanceof Data_BlogPage.ProjectsPage) {
              return "Projects";
          };
          throw new Error("Failed pattern match at Component.NavigationBar (line 69, column 5 - line 69, column 39): " + [ v1.constructor.name ]);
      };
      var renderPageMenu = function (page) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(Data_BlogPage.pathToHash(Data_BlogPage.blogPageToPath(page))), Halogen_HTML_Events.onClick(function (v1) {
              return new Data_Maybe.Just(page);
          }) ])([ Halogen_HTML_Core.text(blogPageToText(page)) ]) ]);
      };
      var renderMenus = Data_Functor.map(Data_Functor.functorArray)(renderPageMenu)([ Data_BlogPage.MainPage.value, Data_BlogPage.ProjectsPage.value, Data_BlogPage.AboutPage.value ]);
      return Halogen_HTML_Elements.header([ Halogen_HTML_Properties.class_(Style_Class.navigationBarClassName) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(Data_BlogPage.pathToHash(Data_BlogPage.blogPageToPath(Data_BlogPage.MainPage.value))) ])([ Halogen_HTML_Core.text("Valhala of Valkyrie") ]) ]), Halogen_HTML_Elements.ul_(renderMenus) ]);
  };
  var initialState = function (v) {
      return Data_Default.def(Data_Default.unitDefault);
  };
  var component = (function () {
      var handleAction = function (a) {
          return Halogen_Query_HalogenM.raise(a);
      };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Component.ProjectsPage"] = $PS["Component.ProjectsPage"] || {};
  var exports = $PS["Component.ProjectsPage"];
  var Constants = $PS["Constants"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Default = $PS["Data.Default"];
  var Data_Foldable = $PS["Data.Foldable"];
  ...
  var projectSections = [ {
      ...
      projects: [ {
          ...
          images: [ "https://avatars0.githubusercontent.com/u/17797042?v=3&s=200" ]
      }, {
          title: "Htaut",
          link: "https://github.com/Ailrun/Htaut",
          images: [ "https://travis-ci.org/Ailrun/Htaut.svg", "https://img.shields.io/hackage/v/htaut.svg?maxAge=2592000" ]
      }, {
          title: "LambdaDB",
      ...
      projects: [ {
          ...
          images: [ "https://img.shields.io/badge/Version-0.02.00-lightgrey.svg?style=flat", "https://img.shields.io/badge/Status-Alpha-yellow.svg?style=flat" ]
      }, {
          title: "coq-commenter",
          link: "https://github.com/Ailrun/coq-commenter",
          images: [ "https://melpa.org/packages/coq-commenter-badge.svg" ]
      } ]
  }, {
      title: "Study",
      projects: [ (function () {
          var v = Data_Default.def(Data_Default.recordDefault()(Data_Default.consDefaultRecord(new Data_Symbol.IsSymbol(function () {
              return "images";
          }))(Data_Default.arrayDefault)()(Data_Default.consDefaultRecord(new Data_Symbol.IsSymbol(function () {
              return "link";
          }))(Data_Default.stringDefault)()(Data_Default.consDefaultRecord(new Data_Symbol.IsSymbol(function () {
              return "title";
          }))(Data_Default.stringDefault)()(Data_Default.nilDefaultRecord)))));
          return {
  ...
  var render = function (v) {
      var renderTop = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.pageTitleClassName) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(Constants.imageRoot + "project.png") ]), Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Projects") ]) ]) ]);
      var renderProject = function (p) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.article_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("-") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(p.link) ])([ Halogen_HTML_Core.text(p.title) ]) ]), Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $9 = Control_Applicative.pure(Control_Applicative.applicativeArray);
              return function ($10) {
                  return Halogen_HTML_Elements.img($9(Halogen_HTML_Properties.src($10)));
              };
          })())(p.images)) ]) ]);
      };
      var renderSection = function (s) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text(s.title) ]), Halogen_HTML_Elements.hr_, Halogen_HTML_Elements.ul_(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidArray)([ Halogen_HTML_Elements.hr_ ])(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $11 = Control_Applicative.pure(Control_Applicative.applicativeArray);
              return function ($12) {
                  return $11(renderProject($12));
              };
          })())(s.projects))) ]);
      };
      var renderBottom = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.pageMainClassName) ])(Data_Functor.map(Data_Functor.functorArray)(renderSection)(projectSections));
      return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_(Style_Class.projectsPageClassName) ])([ renderTop, renderBottom ]);
  };
  var initialState = function (v) {
      return Data_Default.def(Data_Default.unitDefault);
  };
...
(function($PS) {
  ...
  var Component_AboutPage = $PS["Component.AboutPage"];
  var Component_MainPage = $PS["Component.MainPage"];
  var Component_NavigationBar = $PS["Component.NavigationBar"];
  var Component_ProjectsPage = $PS["Component.ProjectsPage"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_BlogPage = $PS["Data.BlogPage"];
  ...
  var MoveToPage = (function () {
      function MoveToPage(value0) {
          this.value0 = value0;
      };
      MoveToPage.create = function (value0) {
          return new MoveToPage(value0);
      };
      return MoveToPage;
  })();
  var render = function (state) {
      var _projectsPage = Data_Default.def(Data_Default.sproxyDefault);
      var _navigationBar = Data_Default.def(Data_Default.sproxyDefault);
      var _mainPage = Data_Default.def(Data_Default.sproxyDefault);
      var _aboutPage = Data_Default.def(Data_Default.sproxyDefault);
      var renderCurrentPage = (function () {
          if (state.currentPage instanceof Data_BlogPage.AboutPage) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "aboutPage";
              }))(Data_Ord.ordUnit)(_aboutPage)(Data_Unit.unit)(Component_AboutPage.component)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentPage instanceof Data_BlogPage.MainPage) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "mainPage";
              }))(Data_Ord.ordUnit)(_mainPage)(Data_Unit.unit)(Component_MainPage.component)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentPage instanceof Data_BlogPage.ProjectsPage) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "projectsPage";
              }))(Data_Ord.ordUnit)(_projectsPage)(Data_Unit.unit)(Component_ProjectsPage.component)(Data_Unit.unit)(Data_Void.absurd);
          };
          throw new Error("Failed pattern match at Component.App (line 61, column 25 - line 64, column 84): " + [ state.currentPage.constructor.name ]);
      })();
      return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "navigationBar";
      }))(Data_Ord.ordUnit)(_navigationBar)(Data_Unit.unit)(Component_NavigationBar.component)(state.currentPage)(function ($10) {
          return Data_Maybe.Just.create(MoveToPage.create($10));
      }), Halogen_HTML_Elements.main_(Control_Applicative.pure(Control_Applicative.applicativeArray)(renderCurrentPage)) ]);
  };
  var initialState = function (currentPage) {
      var v = Data_Default.def(Data_Default.recordDefault()(Data_Default.consDefaultRecord(new Data_Symbol.IsSymbol(function () {
          return "currentPage";
      }))(Data_BlogPage.blogPageDefault)()(Data_Default.nilDefaultRecord)));
      return {
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Style.Font"] = $PS["Style.Font"] || {};
  var exports = $PS["Style.Font"];
  ...
  var Control_Plus = $PS["Control.Plus"];
  var Data_NonEmpty = $PS["Data.NonEmpty"];                
  var fontLargeSize = CSS_Size.vw(1.5);
  var fontHugeSize = CSS_Size.vw(2.0);
  var fontGiantSize = CSS_Size.vw(2.5);
  var fontDefaultSize = CSS_Size.vw(1.0);
  var fontDancing = CSS_Font.fontFamily([ "Dancing Script" ])(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Font.GenericFontFamily(CSS_String.fromString(CSS_Property.isStringValue)("cursive"))));
  exports["fontDancing"] = fontDancing;
  exports["fontDefaultSize"] = fontDefaultSize;
  exports["fontGiantSize"] = fontGiantSize;
  exports["fontHugeSize"] = fontHugeSize;
  exports["fontLargeSize"] = fontLargeSize;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  ...
  var Style_Class = $PS["Style.Class"];
  var Style_Font = $PS["Style.Font"];                
  var white = Color.rgb(0)(0)(0);
  var textWhite = Color.rgba(255)(255)(255)(0.84);
  var textLightBlack = Color.rgba(0)(0)(0)(0.73);
  var textBlack = Color.rgba(0)(0)(0)(0.84);
  var sizeNumber = function (n) {
      return CSS_Size.Size(CSS_String.fromString(CSS_Property.isStringValue)(Data_Show.show(Data_Show.showNumber)(n)));
  };
  var sizeInherit = CSS_Size.Size(CSS_String.fromString(CSS_Property.isStringValue)("inherit"));
  var semisym = function (f) {
      return function (tb) {
          return function (lr) {
              return f(tb)(lr)(tb)(lr);
          };
      };
  };
  var pageTitleHeight = 26.0;
  var navigationBarHeight = 2.5;
  var initialState = function (v) {
      return Data_Default.def(Data_Default.unitDefault);
  };
  var cssProjectsPage = CSS_Stylesheet.select(Style_Class.pageMainSelector)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(80.0)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(semisym(CSS_Geometry.margin)(CSS_Size.vw(3.0))(CSS_Common.auto(CSS_Size.autoSize)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(textLightBlack))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.h2)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingTop(CSS_Size.vw(1.5)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontWeight(CSS_Font.bold))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(Style_Font.fontHugeSize))(function () {
                          return CSS_Geometry.lineHeight(sizeNumber(2.0));
                      });
                  });
              })))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.ul)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_ListStyle_Type.listStyleType(CSS_Common.none(CSS_ListStyle_Type.noneListTypeType)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(semisym(CSS_Geometry.padding)(CSS_Size.nil)(CSS_Size.em(4.0)))(function () {
                          return CSS_Geometry.paddingRight(CSS_Size.nil);
                      });
                  })))(function () {
                      return CSS_Stylesheet.select(CSS_Elements.li)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vw(4.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(Style_Font.fontLargeSize))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.lineHeight(CSS_Size.vw(4.0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.p)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.vw(25.0)))(function () {
                                      return CSS_Display.display(CSS_Display.inlineBlock);
                                  })))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.span)(CSS_Geometry.paddingRight(CSS_Size.em(1.0))))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.a)(CSS_Geometry.width(CSS_Size.em(50.0))))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.div)(CSS_Display.display(CSS_Display.inlineBlock)))(function () {
                                                  return CSS_Stylesheet.select(CSS_Elements.img)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.maxHeight(CSS_Size.vw(4.0)))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingBottom(CSS_Size.em(0.3)))(function () {
  ...
  var cssPageTitle = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vw(pageTitleHeight)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(white))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.img)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(sizeInherit))(function () {
                          return CSS_Geometry.height(sizeInherit);
                      });
                  })))(function () {
                      return CSS_Stylesheet.select(CSS_Elements.header)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.pct(50.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.pct(50.0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.pct(7.0)))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.vw(-pageTitleHeight / 2.0)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vw(pageTitleHeight)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.lineHeight(CSS_Size.vw(pageTitleHeight)))(function () {
                                                      return CSS_Stylesheet.select(CSS_Elements.h1)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(textWhite))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontWeight(CSS_Font.bold))(function () {
                                                              return CSS_Font.fontSize(Style_Font.fontGiantSize);
                                                          });
                                                      }));
                                                  });
                                              });
  ...
  var cssNavigationBar = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vw(navigationBarHeight)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(semisym(CSS_Geometry.margin)(CSS_Size.nil)(CSS_Common.auto(CSS_Size.autoSize)))(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.nil))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.nil))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.zIndex(1))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.rgba(0)(0)(0)(0.72)))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.lineHeight(CSS_Size.vw(navigationBarHeight)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.h1)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(sizeInherit))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(Style_Font.fontLargeSize))(function () {
                                                      return CSS_Stylesheet.select(CSS_Elements.a)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(sizeInherit))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginLeft(CSS_Size.em(0.5)))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Style_Font.fontDancing)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(Style_Font.fontLargeSize))(function () {
                                                                          return CSS_Font.color(textWhite);
                                                                      });
                                                                  });
                                                              });
                                                          });
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.ul)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(sizeInherit))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inline))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(semisym(CSS_Geometry.margin)(CSS_Common.auto(CSS_Size.autoSize))(CSS_Size.nil))(function () {
                                                          return CSS_Display["float"](CSS_Display.floatRight);
                                                      });
                                                  });
                                              })))(function () {
                                                  return CSS_Stylesheet.select(CSS_Elements.li)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(sizeInherit))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(Style_Font.fontLargeSize))(function () {
                                                              return CSS_Stylesheet.select(CSS_Elements.a)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginLeft(CSS_Size.vw(1.0)))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginRight(CSS_Size.vw(1.0)))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Style_Font.fontDancing)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(Style_Font.fontLargeSize))(function () {
                                                                              return CSS_Font.color(textWhite);
                                                                          });
  ...
  var cssCommon = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.importUrl("https://fonts.googleapis.com/css?family=Dancing+Script:400,700&display=swap"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.star)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Size.sym(CSS_Geometry.margin)(CSS_Size.nil))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Size.sym(CSS_Geometry.padding)(CSS_Size.nil))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.prefixed(CSS_Size.valSize)(Data_Semigroup.append(CSS_Property.semigroupPrefixed)(CSS_Common.browsers)(CSS_String.fromString(CSS_Property.isStringPrefixed)("margin-after")))(CSS_Size.nil))(function () {
                  return CSS_Stylesheet.prefixed(CSS_Size.valSize)(Data_Semigroup.append(CSS_Property.semigroupPrefixed)(CSS_Common.browsers)(CSS_String.fromString(CSS_Property.isStringPrefixed)("margin-before")))(CSS_Size.nil);
              });
          });
      })))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.body)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(semisym(CSS_Geometry.margin)(CSS_Size.nil)(CSS_Common.auto(CSS_Size.autoSize)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Overflow.overflowY(CSS_Overflow.scroll))(function () {
                      return CSS_Font.fontSize(Style_Font.fontDefaultSize);
                  });
              });
          })))(function () {
              return CSS_Stylesheet.select(CSS_Elements.a)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text.textDecoration(CSS_Text.noneTextDecoration))(function () {
                  return CSS_Font.color(textBlack);
              }));
          });
      });
  });
  var cssAboutPage = CSS_Stylesheet.select(Style_Class.pageMainSelector)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(semisym(CSS_Geometry.margin)(CSS_Size.vw(5.0))(CSS_Common.auto(CSS_Size.autoSize)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(80.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(textLightBlack))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.h2)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Style_Font.fontDancing)(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontWeight(CSS_Font.bold))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(Style_Font.fontGiantSize))(function () {
                          return CSS_Geometry.lineHeight(sizeNumber(2.0));
                      });
                  });
              })))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Style_Class.alignLeftSelector)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(60.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.article)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingTop(CSS_Size.vw(1.0)))(function () {
                              return CSS_Geometry.paddingLeft(CSS_Size.em(1.0));
                          })))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.h3)(CSS_Font.fontSize(Style_Font.fontHugeSize)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.ul)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_ListStyle_Type.listStyleType(CSS_Common.none(CSS_ListStyle_Type.noneListTypeType)))(function () {
                                      return CSS_Stylesheet.key(CSS_Size.valSize)(CSS_String.fromString(CSS_Property.isStringKey)("text-indent"))(CSS_Size.em(-0.5));
                                  })))(function () {
                                      return CSS_Stylesheet.select(CSS_Elements.li)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingLeft(CSS_Size.em(1.0)))(function () {
                                          return CSS_Font.fontSize(Style_Font.fontLargeSize);
                                      }));
                                  });
                              });
                          });
                      ...
                      return CSS_Stylesheet.select(Style_Class.alignRightSelector)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(30.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Size.sym(CSS_Geometry.margin)(CSS_Size.nil))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display["float"](CSS_Display.floatRight))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.img)(CSS_Geometry.width(CSS_Size.pct(100.0))))(function () {
                                      return CSS_Stylesheet.select(CSS_Elements.h3)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_TextAlign.textAlign(CSS_TextAlign.center))(function () {
                                              return CSS_Font.fontWeight(CSS_Common.normal(CSS_Font.normalFontWeight));
                                          });
                                      }));
                                  });
                              });
  ...
  var bannerHeight = 26.0;
  var cssMainPage = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(textWhite))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.lineHeight(sizeNumber(1.3)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.article)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vw(bannerHeight)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
                      return CSS_Background.backgroundColor(white);
                  });
              });
          })))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.child(Style_Class.alignLeftSelector)(CSS_Elements.header))(CSS_Geometry.left(CSS_Size.pct(7.0))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.child(Style_Class.alignRightSelector)(CSS_Elements.header))(CSS_Geometry.left(CSS_Size.pct(73.0))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.img)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(sizeInherit))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(sizeInherit))(function () {
                              return CSS_Display.position(CSS_Display.absolute);
                          });
                      })))(function () {
                          return CSS_Stylesheet.select(CSS_Elements.header)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vw(bannerHeight)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.vw(-bannerHeight / 2.0)))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.pct(50.0)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.pct(50.0)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.lineHeight(CSS_Size.vw(bannerHeight)))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.div)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_VerticalAlign.verticalAlign(CSS_Common.middle(CSS_VerticalAlign.middleVerticalAlign)))(function () {
                                                              return CSS_Geometry.lineHeight(sizeNumber(1.3));
                                                          });
                                                      })))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.a)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.pct(2.0)))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.vw(1.0)))(function () {
                                                                      return CSS_Stylesheet.key(CSS_Property.valString)(CSS_String.fromString(CSS_Property.isStringKey)("color"))("inherit");
                                                                  });
                                                              });
                                                          })))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.h3)(CSS_Font.fontSize(Style_Font.fontHugeSize)))(function () {
                                                                  return CSS_Stylesheet.select(CSS_Elements.p)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text_Whitespace.textWhitespace(CSS_Text_Whitespace.whitespacePreWrap))(function () {
                                                                      return CSS_Font.fontSize(Style_Font.fontLargeSize);
                                                                  }));
                                                              });
                                                          });
  ...
  var render = function (v) {
      return Halogen_HTML_CSS.stylesheet(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(cssCommon)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Style_Class.navigationBarSelector)(cssNavigationBar))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Style_Class.aboutPageSelector)(cssAboutPage))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Style_Class.mainPageSelector)(cssMainPage))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Style_Class.projectsPageSelector)(cssProjectsPage))(function () {
                          return CSS_Stylesheet.select(Style_Class.pageTitleSelector)(cssPageTitle);
                      });
                  });
              });
          });
...
(function($PS) {
  ...
  var main = function __do() {
      var mayPage = Data_Functor.map(Effect.functorEffect)(Data_BlogPage.pathToBlogPage)(Routing_Hash.getHash)();
      var page = (function () {
          if (mayPage instanceof Data_Maybe.Just) {
              return mayPage.value0;
          };
          if (mayPage instanceof Data_Maybe.Nothing) {
              Routing_Hash.setHash(Data_BlogPage.blogPageToPath(Data_Default.def(Data_BlogPage.blogPageDefault)))();
              return Data_Default.def(Data_BlogPage.blogPageDefault);
          };
          throw new Error("Failed pattern match at Main (line 20, column 11 - line 25, column 15): " + [ mayPage.constructor.name ]);
      })();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Maybe.fromMaybe(body))(Halogen_Aff_Util.selectElement("head")))(function (head) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Style.component)(Data_Unit.unit)(head))(function () {
                  return Halogen_VDom_Driver.runUI(Component_App.component)(page)(body);
              });
          });
      }))();
  };
