...
논리학에서 명제를 통해서 하고 싶은 것은 바로 **논증**(Argument)이다. 논증이란 결론(Conclusion)과 전제(Preposition)라고 불리는 여러 명제로 구성된 논리학의 개념이다. 논증은 주로 $\vdash$(턴스타일, Turnstile)이라는 기호를 사용해 표기한다. 예를 들면
